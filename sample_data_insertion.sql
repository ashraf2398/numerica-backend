-- Sample Data Insertion for Numérica Tax & Accounting Consulting
-- This script will populate all tables with professional data
...
-- 3. SERVICES TABLE
INSERT INTO services (id, title, description, category_id, features, icon, is_published, created_at) VALUES
...
INSERT INTO team_members (id, name, title, description, social_media, image, email, phone, order_index, is_published, created_at) VALUES
(1, 'Ahmed Hassan', 'CEO & Founder', 
...
(2, 'Ashraf Mahmoud', 'Chief Financial Officer', 
...
(3, 'Nour El-Din', 'Senior Tax Consultant', 
...
(4, 'Sarah Johnson', 'Senior Accountant', 
...
(5, 'Michael Chen', 'Financial Planning Specialist', 
...
(6, 'Lisa Rodriguez', 'Business Consultant', 
...
-- 5. CONTACTS TABLE
INSERT INTO contacts (id, addresses, phones, emails, is_published, created_at) VALUES
(1, 
...
-- 6. HOME_BANNER TABLE
INSERT INTO home_banner (id, image_url, title, subtitle, created_at, updated_at) VALUES
(1, 'https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=1200', 
...
(2, 'https://images.unsplash.com/photo-1556761175-b413da4baf72?w=1200',
...
(3, 'https://images.unsplash.com/photo-1551434678-e076c223a692?w=1200',
...
INSERT INTO testimonials (id, name, content, company, position, avatar_url, created_at, updated_at, display_order) VALUES
(1, 'John Smith', 
...
-- 8. TRUSTED_COMPANIES TABLE
INSERT INTO trusted_companies (id, logo_url, company_name, display_order, created_at, updated_at) VALUES
(1, 'https://images.unsplash.com/photo-1560472354-b33ff0c44a43?w=200', 'Microsoft', 1, NOW(), NOW()),
(2, 'https://images.unsplash.com/photo-1611162617213-7d7a39e9b1d7?w=200', 'Google', 2, NOW(), NOW()),
(3, 'https://images.unsplash.com/photo-1612815154858-60aa4c59eaa6?w=200', 'Apple', 3, NOW(), NOW()),
(4, 'https://images.unsplash.com/photo-1611162616475-46b635cb6868?w=200', 'Amazon', 4, NOW(), NOW()),
(5, 'https://images.unsplash.com/photo-1612815154858-60aa4c59eaa6?w=200', 'Meta', 5, NOW(), NOW()),
(6, 'https://images.unsplash.com/photo-1560472354-b33ff0c44a43?w=200', 'Netflix', 6, NOW(), NOW());
...
-- 10. CONSULTATION_REQUESTS TABLE (Sample requests)
INSERT INTO consultation_requests (id, name, email, phone, preferred_date, message, status, created_at) VALUES
(1, 'Alice Johnson', 'alice@example.com', '+1 (555) 111-1111', '2024-06-25 10:00:00', 
...
(2, 'Bob Wilson', 'bob@example.com', '+1 (555) 222-2222', '2024-06-26 14:00:00',
'Looking for accounting services for my startup. Need help setting up proper bookkeeping and financial reporting systems.',
'confirmed', NOW()),

(3, 'Carol Davis', 'carol@example.com', '+1 (555) 333-3333', '2024-06-27 11:00:00',
...
SELECT setval('home_banner_id_seq', (SELECT MAX(id) FROM home_banner));
SELECT setval('testimonials_id_seq', (SELECT MAX(id) FROM testimonials));
SELECT setval('trusted_companies_id_seq', (SELECT MAX(id) FROM trusted_companies));
SELECT setval('consultation_requests_id_seq', (SELECT MAX(id) FROM consultation_requests)); 